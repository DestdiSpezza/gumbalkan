...
`GUM_rate_limits`, `GUM_reels`, `GUM_sponsors`, `GUM_photos`.
...
| `admin/index.php` | Admin panel – login a správa reels / sponzorů / podporovatelů / foto galerie (sekce `#gallery`, hromadný upload → `photos/gallery/`, zobrazí se na `index.php`). |
